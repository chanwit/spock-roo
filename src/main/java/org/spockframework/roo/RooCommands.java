package org.spockframework.roo;
...
@Service
public class RooCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    ...
    /**
     * Get a reference to the RooOperations from the underlying OSGi container
     */
    ...
    protected void deactivate(ComponentContext context) {
        staticFieldConverter.remove(RooPropertyName.class);
    }
    ...
    public void sayHello(
        ...
        @CliOption(key = "countryOfOrigin", mandatory = false, help = "Country of orgin") RooPropertyName country) {
        
        log.info("Welcome " + name + "!");
        log.warning("Country of origin: " + (country == null ? RooPropertyName.NOT_SPECIFIED.getPropertyName() : country.getPropertyName()));
